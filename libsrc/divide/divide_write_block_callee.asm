...
XDEF divide_write_block_asmentry
XDEF ASMDISP_DIVIDE_WRITE_BLOCK_CALLEE
...
DEFC ASMDISP_DIVIDE_WRITE_BLOCK_CALLEE = divide_write_block_asmentry - divide_write_block_callee
